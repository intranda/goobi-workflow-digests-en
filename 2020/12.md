...
![Entry into the Archive Management Plugin](../.gitbook/assets/2012_archive_01_en.png)
...
![User interface of the Archive Management Plugin](../.gitbook/assets/2012_archive_02_en.png)
...
{% embed url="https://github.com/intranda/goobi-plugin-administration-archive-management" caption="https://github.com/intranda/goobi-plugin-administration-archive-management" %}
...
![Performant display and search in extensive vocabularies](../.gitbook/assets/2012_vocabulary2_en.png)
...
![Definition of a vocabulary and the column display](../.gitbook/assets/2012_vocabulary3_en.png)
...
![Revised upload area for the vocabulary](../.gitbook/assets/2012_vocabulary1_en.png)
...
![Use of lower case letters in Roman pagination possible](../.gitbook/assets/2012_pagination3_en.png)
...
![Display of the file name as a tooltip](../.gitbook/assets/2012_pagination1_en.png)
...
![Better readability of the pagination](../.gitbook/assets/2012_pagination2_en.png)
...
![Excel export of executed GoobiScripts](../.gitbook/assets/2012_goobiscript_export.png)
...
![Mass upload of files with automatic creation of processes](../.gitbook/assets/2012_processCreation_en.png)

The detailed documentation of the plugin can be found here:

{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/workflow/intranda_workflow_fileupload_processcreation" caption="https://docs.goobi.io/goobi-workflow-plugins-en/workflow/intranda_workflow_fileupload_processcreation" %}

The source code for the plugin can be found as usual on GitHub published here:

{% embed url="https://github.com/intranda/goobi-plugin-workflow-fileupload-processcreation" caption="https://github.com/intranda/goobi-plugin-workflow-fileupload-processcreation" %}
...
{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/step/intranda_step_imagemetadataextraction" caption="https://docs.goobi.io/goobi-workflow-plugins-en/step/intranda_step_imagemetadataextraction" %}

The source code of the plugin was published here:

{% embed url="https://github.com/intranda/goobi-plugin-step-image-metadata-extraction" caption="https://github.com/intranda/goobi-plugin-step-image-metadata-extraction" %}
...
https://github.com/intranda/goobi-workflow/commit/2094d049b8b81b7af3ccf8d51e0b1801d273a847<br/>https://github.com/intranda/goobi-workflow/commit/064c2c0b95d826d5d656aa11936f3e7379af9327<br/>https://github.com/intranda/goobi-workflow/commit/7ef268114a40b6c2a224884fde7dcb7e2c2aa8b4<br/>https://github.com/intranda/goobi-workflow/commit/cc2cabec9d35a10a98768db66892d9e831b2abec
