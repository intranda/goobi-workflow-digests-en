...
![The LayoutWizzard plugin for cropping images using the example of double pages](../.gitbook/assets/2004_layoutwizzard.png)
...
{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/step-plugins/layoutwizzard" caption="https://docs.goobi.io/goobi-workflow-plugins-en/step-plugins/layoutwizzard" %}
...
{% embed url="https://github.com/google/draco" caption="https://github.com/google/draco" %}
...
![3D objects visualised within the METS editor of Goobi workflow](../.gitbook/assets/2004_3d.png)
...
![Manipulations to the image stack in the METS Editor immediately affect all folders and the METS file](../.gitbook/assets/2004_mets_files.png)
...
![The GoobiScript createStep and its associated parameters](../.gitbook/assets/2004_goobiscript.png)
...
![Playback of audio material within the METS editor of Goobi workflow](../.gitbook/assets/2004_audio.png)

![Displaying video material within the METS editor of Goobi workflow](../.gitbook/assets/2004_video.png)
...
![Interface of the administration plugin for adopting the data in the anchor record as the master for all associated Goobi operations](../.gitbook/assets/2004_master_anchor.png)

Besides some small optical adjustments, a detailed documentation has been created for this plugin. This is available here:

{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/administration/plugin\_intranda\_administration\_copyanchor" caption="https://docs.goobi.io/goobi-workflow-plugins-en/administration/plugin\_intranda\_administration\_copyanchor" %}
...
![Finding aid from the Stadtarchiv Duderstadt within the METS-Editor](../.gitbook/assets/2004_duderstadt.png)
...
{% embed url="https://docs.goobi.io/goobi-workflow-en/admin/7/7.5-goobi\_rest.xml" caption="https://docs.goobi.io/goobi-workflow-en/admin/7/7.5-goobi\_rest.xml" %}
