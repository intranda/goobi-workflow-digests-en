...
![Screenshot projects with identifiers](2003_project_identifier.png)
...
![Manuscript editor with active and inactive fields](2003_codicological_editor1.png)
...
![Use of a vocabulary in a drop-down field using the example of a keyword](2003_vocabulary6.png)
...
![Use of a vocabulary via a search mask using the example of a location](2003_vocabulary7.png)
...
[https://docs.goobi.io/goobi-workflow-plugins-en/step-plugins/intranda\_step\_metadata\_replacement](https://docs.goobi.io/goobi-workflow-plugins-en/step-plugins/intranda_step_metadata_replacement)
...
| Type | Description |
| :--- | :--- |
| PART\_AND\_FULL | Plugins with partial and complete user interface at the same time \(example: revised Image-QA-Plugin\) |
...
![Image-QA-Plugin with a Part-GUI and Full-GUI simultaneously](2003_imageQAplugin3.png)
...
[https://docs.goobi.io/goobi-workflow-plugins-en/step-plugins/intranda\_step\_imageqa](https://docs.goobi.io/goobi-workflow-plugins-en/step-plugins/intranda_step_imageqa)
...
[https://docs.goobi.io/goobi-workflow-plugins-en/workflow-plugins/goobi-plugin-workflow-excelimport](https://docs.goobi.io/goobi-workflow-plugins-en/workflow-plugins/goobi-plugin-workflow-excelimport)
