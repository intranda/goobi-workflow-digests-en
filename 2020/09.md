...
![The circumference of a tectonic tree, with its nodes and sub-nodes, can assume enormous proportions.](../.gitbook/assets/2009_tektonik_mockup_01.png)
...
![The detection of each node follows the ISAD(G) standard.](../.gitbook/assets/2009_tektonik_mockup_02.png)
...
{% embed url="https://docs.goobi.io/goobi-workflow-en/manager/7/7.4#goobiscript-metadatachangetype" caption="https://docs.goobi.io/goobi-workflow-en/manager/7/7.4#goobiscript-metadatachangetype" %}

![GoobiScripts have been renamed to make them easier to use.](../.gitbook/assets/2009_goobiscript_en.png)
...
![The generic export plugin can be used repeatedly in several steps of the workflow](../.gitbook/assets/2009_exportPackage_en.png)
...
{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/step/intranda_step_deletecontent" caption="https://docs.goobi.io/goobi-workflow-plugins-en/step/intranda_step_deletecontent" %}
...
![The plugin for generating identifiers can be used at any point in the workflow](../.gitbook/assets/2009_generate_identifier_en.png)

As usual, more information about the plugin can be found in the online documentation:

{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/step/intranda_step_generateidentifier" caption="https://docs.goobi.io/goobi-workflow-plugins-en/step/intranda_step_generateidentifier" %}

The source code of the plugin is available at the following URL:

{% embed url="https://github.com/intranda/goobi-plugin-step-generateIdentifier" caption="https://github.com/intranda/goobi-plugin-step-generateIdentifier" %}
...
![Sorting of left and right pages of a book using a plugin](../.gitbook/assets/2009_reorder.png)

As usual, more information about the plugin can be found in the online documentation:

{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/step/intranda_step_reorder_images" caption="https://docs.goobi.io/goobi-workflow-plugins-en/step/intranda_step_reorder_images" %}

The source code of the plugin is available at the following URL:

{% embed url="https://github.com/intranda/goobi-plugin-step-reorder-images" caption="https://github.com/intranda/goobi-plugin-step-reorder-images" %}
...
{% embed url="https://www.w3.org/TR/WCAG21/" caption="https://www.w3.org/TR/WCAG21/" %}

![WCAG Accessibility Guidelines](../.gitbook/assets/2009_wcag.png)
...
{% embed url="https://de.wikipedia.org/wiki/Web_Content_Accessibility_Guidelines" caption="https://de.wikipedia.org/wiki/Web_Content_Accessibility_Guidelines" %}

{% embed url="https://en.wikipedia.org/wiki/Web_Content_Accessibility_Guidelines" caption="https://en.wikipedia.org/wiki/Web_Content_Accessibility_Guidelines" %}

{% embed url="https://wikis.ec.europa.eu/display/WEBGUIDE/01.+Accessibility+overview" caption="https://wikis.ec.europa.eu/display/WEBGUIDE/01.+Accessibility+overview" %}
...
{% embed url="https://github.com/intranda/goobi-workflow/releases" caption="https://github.com/intranda/goobi-workflow/releases" %}

![Possibility to download a release for each monthly published version](../.gitbook/assets/2009_github_release.png)

And the latest stable version of Goobi workflow can always be downloaded from this URL:

{% embed url="https://github.com/intranda/goobi-workflow/releases/latest" caption="https://github.com/intranda/goobi-workflow/releases/latest" %}
