...
![Sequence of data exchange](../.gitbook/assets/2006_goobi_to_goobi_en.png)
...
{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/administration/plugin\_intranda\_adminstration\_goobi2goobi/step\_1\_export" caption="https://docs.goobi.io/goobi-workflow-plugins-en/administration/plugin\_intranda\_adminstration\_goobi2goobi/step\_1\_export" %}
...
{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/administration/plugin\_intranda\_adminstration\_goobi2goobi/step\_2\_transfer" caption="https://docs.goobi.io/goobi-workflow-plugins-en/administration/plugin\_intranda\_adminstration\_goobi2goobi/step\_2\_transfer" %}
...
![User interface for importing the data](../.gitbook/assets/2006_goobi_to_goobi2_en.png)

Detailed documentation is also available for this:

{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/administration/plugin\_intranda\_adminstration\_goobi2goobi/step\_3\_import" caption="https://docs.goobi.io/goobi-workflow-plugins-en/administration/plugin\_intranda\_adminstration\_goobi2goobi/step\_3\_import" %}
...
{% embed url="https://github.com/intranda/goobi-plugin-administration-goobi2goobi-export" caption="https://github.com/intranda/goobi-plugin-administration-goobi2goobi-export" %}

{% embed url="https://github.com/intranda/goobi-plugin-administration-goobi2goobi-import" caption="https://github.com/intranda/goobi-plugin-administration-goobi2goobi-import" %}
...
![Overview of the documented plugins](../.gitbook/assets/2006_plugin_docs_en.png)

An overview of the currently publicly documented Goobi workflow plugins can be found here:

{% embed url="https://docs.goobi.io/goobi-workflow-plugins-en/" caption="https://docs.goobi.io/goobi-workflow-plugins-en/" %}
...
![GitHub site of intranda with over 70 repositories](../.gitbook/assets/2006_github_repositories.png)

In total we have now published the source code of 48 plugins:

![48 plugins already public with the source code](../.gitbook/assets/2006_github_plugins.png)
...
![New GoobiScript to change the type](../.gitbook/assets/2006_goobiScript_en.png)
...
![METS Editor with shorter loading times](../.gitbook/assets/2006_ajax_en.png)
...
![Possible directory names from now on](../.gitbook/assets/2006_folders_new.png)
