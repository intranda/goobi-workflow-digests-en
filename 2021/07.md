...
![Selection of a parent entity for the creation of multiple processes](../.gitbook/assets/2107_archiveprocesses1_en.png)
...
![A separate process is created for each record based on the selected process template](../.gitbook/assets/2107_archiveprocesses2_en.png)
...
![User interface for creating new record groups](../.gitbook/assets/2107_archive_management_new_en.png)
...
![Editing data is possible in several windows](../.gitbook/assets/2107_multitab_en.png)
...
![Java 11 will be required on all systems from September](../.gitbook/assets/2107_java11.png)
...
![Within the workflows, a workflow step must be marked as an export so that an export is also possible from other areas of Goobi workflow](../.gitbook/assets/2107_export_en.png)
...
![Downloading the log file of a process from the process list](../.gitbook/assets/2107_download_log_file_en.png)
...
![Plugin to fetch images in the workflow](../.gitbook/assets/2107_fetch_images1_en.png)
...
![Buttons for projects and user groups are now only displayed if they can be used](../.gitbook/assets/2107_assign_projects_en.png)
...
This search finds all processes that are in the batch with the ID '42'. The opposite of this search, i.e. all those processes that are *not* in batch `42`, was not possible until now. This new search option has now been implemented and looks like this:
...
{% embed url="https://docs.goobi.io/goobi-workflow-en/manager/7/7.1" caption="https://docs.goobi.io/goobi-workflow-en/manager/7/7.1" %}
...
![Plugin for harvesting EAD files from an OAI-PMH interface](../.gitbook/assets/2107_ead_harvest_en.png)
...
![Display of the institutions column no longer visible if only one institution is present](../.gitbook/assets/2107_institutions_en.png)
...
![Search by user and sort in all columns](../.gitbook/assets/2107_users_en.png)
...
![The display of sessions was restricted to logged-in users only](../.gitbook/assets/2107_sessions_en.png)
...
![KulturNav as an important standards database for cultural institutions is now connected to Goobi](../.gitbook/assets/2107_kulturnav.png)
...
{% embed url="https://github.com/intranda/goobi-workflow/pull/23" caption="https://github.com/intranda/goobi-workflow/pull/23" %}
...
![New warning when resetting pagination](../.gitbook/assets/2107_reset_pagination_en.png)
...
![Deactivated projects are also highlighted in colour in the production templates](../.gitbook/assets/2107_inactive_projects_en.png)
...
![The extended dashboard hides empty widgets](../.gitbook/assets/2107_dashboard_en.png)
...
The current version number of Goobi workflow with this release is: **21.07**.
